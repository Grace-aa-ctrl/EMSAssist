"""Train a randomly initialized MobileBERT with an explicit MLP classification head."""
...
class MobileBertWithMLP(nn.Module):
    """Randomly initialized MobileBERT followed by a trainable two-layer MLP."""
...
def main():
    ...
    parser.add_argument("--model_path", type=Path, default=Path("/home/xiangling/EMSAssist/BERT_merged/model/symptom_text_mobilebert_random_init_mlp.pt"))
    parser.add_argument("--evaluation_path", type=Path, default=Path("/home/xiangling/EMSAssist/BERT_merged/evaluation/symptom_text_mobilebert_random_init_mlp_metrics.txt"))
    ...
    torch.save({"model_state_dict": model.state_dict(), "model_name": args.model_name,
                "architecture": "RandomlyInitializedMobileBertWithMLP",
                "initialization": "random", "num_classes": metadata["num_classes"],
    ...
    lines = ["Randomly Initialized Symptom Text MobileBERT + MLP Evaluation",
             "==========================================================", "",
