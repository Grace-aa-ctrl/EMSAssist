"""Tune Bio_ClinicalBERT on concatenated symptom text and evaluate the test split."""
...
def new_model(args, num_classes):
    return AutoModelForSequenceClassification.from_pretrained(
        args.model_name, num_labels=num_classes, local_files_only=args.local_files_only)
...
def main():
    ...
    parser.add_argument("--model_path", type=Path, default=Path("/home/xiangling/EMSAssist/BERT_merged/model/symptom_text_bert.pt"))
    parser.add_argument("--evaluation_path", type=Path, default=Path("/home/xiangling/EMSAssist/BERT_merged/evaluation/symptom_text_bert_metrics.txt"))
    ...
    torch.save({"model_state_dict": model.state_dict(), "model_name": args.model_name,
                ...
                "config": selected["config"], "selected_epoch": selected["best"]["epoch"],
                "max_length": args.max_length, "seed": args.seed}, args.model_path)
    ...
    lines = ["Symptom Text Bio_ClinicalBERT Evaluation", "========================================", "",
