"""Train MobileBERT with four separately encoded bag-of-words segments."""
...
DEFAULT_ARGUMENTS = {
    ...
    "--model_path": (
        ...
        "symptom_text_mobilebert_separate_bow.pt"
    ),
    "--evaluation_path": (
        "/home/xiangling/EMSAssist/BERT_separated/evaluation/"
        "symptom_text_mobilebert_separate_bow_metrics.txt"
    ),
}
