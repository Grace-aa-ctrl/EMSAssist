"""Fine-tune MobileBERT by encoding four symptom fields separately before an MLP."""
...
def main():
    ...
    parser.add_argument("--model_path", type=Path, default=Path("/home/xiangling/EMSAssist/BERT_separated/model/symptom_text_mobilebert_separated_mlp.pt"))
    parser.add_argument("--evaluation_path", type=Path, default=Path("/home/xiangling/EMSAssist/BERT_separated/evaluation/symptom_text_mobilebert_separated_mlp_metrics.txt"))
    ...
    lines = ["Separated Symptom Text MobileBERT + MLP Evaluation", "====================================================", "",
