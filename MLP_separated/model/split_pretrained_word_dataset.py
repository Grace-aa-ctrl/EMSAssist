...
def main() -> None:
    ...
    parser.add_argument("--embedding_dir", type=Path, default=Path("/home/xiangling/EMSAssist/MLP_separated/embedding/embedding_pretrained"))
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("/home/xiangling/EMSAssist/MLP_separated/dataset/pretrained_word"))
