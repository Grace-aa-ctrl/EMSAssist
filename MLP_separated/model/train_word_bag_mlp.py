...
def batches(x, y, batch_size, shuffle, rng):
  ...
  for start in range(0, len(indexes), batch_size):
    idx = indexes[start:start + batch_size]
    yield x[idx].toarray(), y[idx]
...
def main():
  parser = argparse.ArgumentParser(description="Tune and evaluate an MLP on word-bag embeddings.")
  parser.add_argument("--dataset_dir", default="/home/xiangling/EMSAssist/MLP_separated/dataset/word_bag")
  parser.add_argument("--model_path", default="/home/xiangling/EMSAssist/MLP_separated/model/word_bag_mlp.pt")
  parser.add_argument("--evaluation_path", default="/home/xiangling/EMSAssist/MLP_separated/evaluation/word_bag_mlp_metrics.txt")
