...
def main():
  ...
  parser.add_argument("--dataset_dir", default="/home/xiangling/EMSAssist/MLP_merged/dataset/word_bag")
  parser.add_argument("--model_path", default="/home/xiangling/EMSAssist/MLP_merged/model/word_bag_mlp.pt")
  parser.add_argument("--evaluation_path", default="/home/xiangling/EMSAssist/MLP_merged/evaluation/word_bag_mlp_metrics.txt")
