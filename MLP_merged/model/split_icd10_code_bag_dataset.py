...
def main():
  ...
  parser.add_argument("--embedding_dir", default="/home/xiangling/EMSAssist/MLP_merged/embedding/encoding_one-hot/icd10_bag_output")
  parser.add_argument("--output_dir", default="/home/xiangling/EMSAssist/MLP_merged/dataset/icd10_code_bag")
  ...
  x = sparse.load_npz(source / "icd10_bag.npz").tocsr().astype(np.float32)
  ...
  metadata = {
    "source_embedding": str(source / "icd10_bag.npz"),
    "seed": args.seed,
