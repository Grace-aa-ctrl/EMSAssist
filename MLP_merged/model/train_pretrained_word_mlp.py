...
def main() -> None:
    ...
    parser.add_argument("--dataset_dir", type=Path, default=Path("/home/xiangling/EMSAssist/MLP_merged/dataset/pretrained_word"))
    parser.add_argument("--model_path", type=Path, default=Path("/home/xiangling/EMSAssist/MLP_merged/model/pretrained_word_mlp.pt"))
    parser.add_argument("--evaluation_path", type=Path, default=Path("/home/xiangling/EMSAssist/MLP_merged/evaluation/pretrained_word_mlp_metrics.txt"))
