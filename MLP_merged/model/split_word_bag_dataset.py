...
def main():
  parser = argparse.ArgumentParser(description="Create stratified 70/10/20 word-bag train/validation/test splits.")
  parser.add_argument("--embedding_dir", default="/home/xiangling/EMSAssist/MLP_merged/embedding/encoding_one-hot/word_bag_output")
  parser.add_argument("--output_dir", default="/home/xiangling/EMSAssist/MLP_merged/dataset/word_bag")
  ...
  x = sparse.load_npz(source / "word_bag.npz").tocsr().astype(np.float32)
  labels = np.load(source / "protocol_ids.npy")
  keys = np.load(source / "pcr_keys.npy")
  ...
  metadata = {
    "source_embedding": str(source / "word_bag.npz"),
    "seed": args.seed,
